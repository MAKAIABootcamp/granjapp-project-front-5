...
const HeaderTablet = () => {
  ...
  return (
    <div className="bg-[#34d116] h-[60px] w-full flex relative">
      ...
      <div
       ...
       top-6 flex relative left-[-40px] rounded-[10px] w-full "
      >
        <BsSearch className="w-4 h-4 top-1 flex absolute left-1" />
        <input
          type="text"
          placeholder="Buscar en granjapp"
          className="rounded-[10px] bg-[#b6f1d7] flex absolute left-6 text-[14px] h-6 pl-2 w-full"
        />
